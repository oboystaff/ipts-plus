$(document).ready(function () {
    ...
    function load_data(from_date = '', to_date = '', assembly_code = '', report_type = '', status = '') {
        var url = $("input[name='property-report_url']").attr("url");
        ...
        try {
            $('#file-export').DataTable({
                ...
                columns: [
                    ...
                    {data: 'digital_address', name: 'digital_address'},
                    {data: 'location', name: 'location'},
                    {data: 'street_name', name: 'street_name'},
                    {data: 'rated', name: 'rated'},
                    {data: 'validated', name: 'validated'},
                    {data: 'property_number', name: 'property_number'},
                    {data: 'owner_account', name: 'owner_account'},
                    {data: 'owner_name', name: 'owner_name'},
                    {data: 'ratable_value', name: 'ratable_value'},
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    $('#total_ratable').html(format_money(total_ratable));
                }
            });
        } catch (err) {
