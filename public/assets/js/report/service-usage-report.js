$(document).ready(function () {
    ...
    $('.generate_report').on('click', function(event) {
        ...
        if ($('select[name="report_type"]').val() == 1) {
            ...
            load_data(from_date, to_date, report_type, status);
        } else {
            $('#summary').show();
            $('#details').hide();
            $('#graph').show();
    ...
    function load_data(from_date = '', to_date = '', report_type = '', status = '') {
        var url = $("input[name='service-usage-report_url']").attr("url");
        ...
        try {
            $('#file-export').DataTable({
                ...
                columns: [
                    ...
                    {data: 'service_used', name: 'service_used'},
                    {data: 'usage_date', name: 'usage_date'},
                    {data: 'service_channel', name: 'service_channel'},
                    {data: 'number_of_request', name: 'number_of_request'},
