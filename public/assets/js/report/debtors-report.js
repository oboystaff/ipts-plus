$(document).ready(function () {
    ...
    function load_data(from_date = '', to_date = '', assembly_code = '', report_type = '', status = '') {
        var url = $("input[name='debtors-report_url']").attr("url");
        ...
        try {
            $('#file-export').DataTable({
                ...
                columns: [
                    ...
                    {data: 'bills_id', name: 'bills_id'},
                    {data: 'name', name: 'name'},
                    {data: 'billing_date', name: 'billing_date'},
                    {data: 'bills_year', name: 'bills_year'},
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    $('#total_arrears').html(format_money(total_arrears));
                    $('#total_amount').html(format_money(total_amount));
                    $('#total_due').html(format_money(total_due));
                }
            });
        } catch (err) {
