$(document).ready(function () {
    ...
    function load_data(from_date = '', to_date = '', assembly_code = '', report_type = '', status = '') {
        var url = $("input[name='location-analysis-report_url']").attr("url");
        ...
        try {
            $('#file-export').DataTable({
                ...
                columns: [
                    ...
                    {data: 'number_of_taxpayers', name: 'number_of_taxpayers'},
                    {data: 'number_of_properties', name: 'number_of_properties'},
                    {data: 'total_billed_amount', name: 'total_billed_amount'},
                    {data: 'total_collected_amount', name: 'total_collected_amount'},
                    {data: 'outstanding_amount', name: 'outstanding_amount'},
                    {data: 'collection_rate', name: 'collection_rate'},
                    {data: 'average_tax_per_property', name: 'average_tax_per_property'}
                ],
                language: {
                    paginate: {
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    // Update status DIV
                    $('#title').html('Total (GHS)');
                    $('#total_taxpayers').html(format_money(total_taxpayers));
                    $('#total_properties').html(format_money(total_properties));
                    $('#total_billed').html(format_money(total_billed));
                    $('#total_payment').html(format_money(total_payment));
                    $('#total_outstan').html(format_money(total_outstan));
                    $('#total_rate').html(format_money(total_rate));
