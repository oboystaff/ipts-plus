$(document).ready(function () {
    ...
    function load_data(from_date = '', to_date = '', assembly_code = '', report_type = '', status = '') {
        var url = $("input[name='tax-collection-report_url']").attr("url");
        ...
        try {
            $('#file-export').DataTable({
                ...
                columns: [
                    ...
                    {data: 'momo_total', name: 'momo_total'},
                    {data: 'cash_total', name: 'cash_total'},
                    {data: 'total_amount', name: 'total_amount'},
                    {data: 'transaction_no', name: 'transaction_no'},
                    {data: 'frequently_used', name: 'frequently_used'}
                ],
                language: {
                    paginate: {
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    $('#momo_total').html(format_money(momo_total));
                    $('#cash_total').html(format_money(cash_total));
                    $('#total_trans').html(total_trans);
