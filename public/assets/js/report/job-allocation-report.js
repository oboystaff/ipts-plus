$(document).ready(function () {
    ...
    $('.generate_report').on('click', function(event) {
        ...
        var supervisor = $('select[name="supervisor_id"]').val();
        var agent = $('select[name="agent_id"]').val();
        ...
        if ($('select[name="report_type"]').val() == 1) {
            ...
            load_data(from_date, to_date, assembly_code, report_type, supervisor, agent);
        } else {
            $('#summary').show();
            $('#details').hide();
            $('#graph').show();
            ...
            load_summary(from_date, to_date, level_type, agent);
        }
    });
    ...
    function load_data(from_date = '', to_date = '', assembly_code = '', report_type = '', supervisor = '', agent = '') {
        var url = $("input[name='job-allocation-report_url']").attr("url");
        ...
        try {
            $('#file-export').DataTable({
                ...
                footerCallback: function (row, data, start, end, display) {
                    ...
                    // $('#total_amount').html(format_money(total_amount));
                }
            });
        } catch (err) {
