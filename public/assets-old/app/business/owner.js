...
var ISearch = function () {
    ...
    return {
        ...
        init: function () {
            ...
            $(document).on('click', '#owners-table tbody tr .lnk-biz-owner', function (e) {
                e.preventDefault();
                e.stopImmediatePropagation();
                ...
                var msg = 'Are You Sure You Want To Set ' + fullName + " As The New Owner For " + bizName;
        ...
        changeOwner: function (ownerId) {
            var ajaxOptions = {
                ...
                data: JSON.stringify({_token: searchForm.attr('data-token'), bizId: searchForm.attr('data-biz-id'), ownerId: ownerId}),
        ...
        getActionBtns: function (record) {
            return '<a class="btn btn-pill btn-xs btn-outline-primary btn-primary-dark  text-bold lnk-biz-owner" title="Set As New Owner"><i class="icofont icofont-user text-primary"></i> Set As New Owner</a>';
