...
class CreateCustomerRequestFront extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'telephone_number' => 'nullable|string|digits:10|unique:citizens,telephone_number',
            'org_telephone_number' => 'nullable|string|digits:10|unique:citizens,telephone_number',
