                    ...
                    <div class="card-body px-0">
                        <div class="table-responsive">
                            <table id="file-export" class="table table-bordered text-nowrap w-100">
                                ...
                                <tbody>
                                    @foreach ($customerSupports as $index => $customerSupport)
                                        @php
                                            $name = '';
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $name ?? 'N/A' }}</td>
                                            <td>{{ $customerSupport->status }}</td>
                                            <td>{{ $customerSupport->assembly->name ?? '' }}</td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"
                                                                href=" {{ route('customer-supports.show', $customerSupport) }}">View
                                                            </a>
                                                            @if ($customerSupport->status !== 'Closed')
                                                                <a class="dropdown-item"
                                                                    href=" {{ route('customer-supports.edit', $customerSupport) }}">Edit
                                                                </a>
                                                            @endif
                                                        </div>
                                                    </div>
