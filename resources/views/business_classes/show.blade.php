                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <div>
                        ...
                        <p class="mb-0 text-muted fs-14">
                            You are Viewing A Business Class Record from your central database repository.
                        </p>
                    </div>
                    ...
                    <div class="card-body">
                        <form class="row g-3 needs-validation" method="POST"
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('business_type_id') is-invalid @enderror"
                                    id="business_type_id" name="business_type_id" placeholder="Business Class Name"
                                    value="{{ $businessClass->businessType->name ?? '' }}" readonly>
                            ...
                            <div class="col-sm-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    ...
                                    value="{{ $businessClass->name }}" readonly>
