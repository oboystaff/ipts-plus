                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <div>
                        ...
                        <p class="mb-0 text-muted fs-14">
                            You are Viewing all Businesses Record from your
                            central database repository.
                        </p>

                    </div>
                    @can('businesses.create')
                        <a href="{{ route('businesses.create') }}" class="btn btn-sm btn-primary">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <div class="py-2">
                                                            <a class="dropdown-item"
                                                                href=" {{ route('businesses.show', $business) }}">View
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href=" {{ route('businesses.edit', $business) }}">Edit
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
