            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header flex-wrap d-flex justify-content-between">
                        <div>
                            <h4 class="card-title">Import Assembly Customers</h4>
                        </div>

                        <div>
                            <a href="{{ route('citizens.downloadTemplate') }}" class="btn btn-success btn-sm ms-2">Download
                                Rate Payer Template</a>
