...
<body bgcolor="#A0A0A0" vlink="blue" link="blue">
    ...
    <div class="center-wrapper">
        <div id="page1-div" class="page-content">
            ...
            <p style="position:absolute;top:30px;left:360px;white-space:nowrap;font-size:18px" class="ft11">
            ...
            <p style="position:absolute;top:99px;left:135px;white-space:nowrap" class="ft11">
                <b>{{ $account_number }}</b>
            </p>
            <p style="position:absolute;top:172px;left:77px;white-space:nowrap" class="ft11"><b>SOUTH&#160;ODORKOR</b>
            </p>
            ...
            <p style="position:absolute;top:327px;left:150px;white-space:nowrap" class="ft10">
                <b>{{ number_format($rateableValue, 2) }}</b>
            </p>
            <p style="position:absolute;top:363px;left:150px;white-space:nowrap" class="ft10">
                <b>{{ $bill->rate_imposed }}</b>
            </p>
            <p style="position:absolute;top:388px;left:180px;white-space:nowrap" class="ft10">
                <b>{{ number_format($bill->arrears, 2) }}</b>
            </p>
            <p style="position:absolute;top:415px;left:180px;white-space:nowrap" class="ft10">
                <b>{{ number_format($bill->amount, 2) }}</b>
            </p>
            <p style="position:absolute;top:442px;left:180px;white-space:nowrap" class="ft10">
                <b>{{ number_format($basicRate, 2) }}</b>
            </p>
            <p style="position:absolute;top:473px;left:180px;white-space:nowrap" class="ft10">
                <b>{{ number_format($totalAmount, 2) }}</b>
            </p>
            <p style="position:absolute;top:177px;left:377px;white-space:nowrap" class="ft12">
                <b>SOUTH&#160;ODORKOR</b>
            </p>
            <p style="position:absolute;top:211px;left:377px;white-space:nowrap" class="ft12">
                <b>{{ strtoupper($propertyUse) }}</b>
            </p>
            <p style="position:absolute;top:243px;left:377px;white-space:nowrap" class="ft12">
                <b>FIRST&#160;CLASS&#160;{{ strtoupper($zone) }}</b>
            </p>
            <p style="position:absolute;top:321px;left:450px;white-space:nowrap" class="ft11">
                <b>{{ number_format($rateableValue, 2) }}</b>
            </p>
            <p style="position:absolute;top:382px;left:450px;white-space:nowrap" class="ft11">
                <b>{{ $bill->rate_imposed }}</b>
            </p>
            <p style="position:absolute;top:292px;left:730px;white-space:nowrap" class="ft11">
                <b>{{ number_format($bill->arrears, 2) }}</b>
            </p>
            <p style="position:absolute;top:319px;left:730px;white-space:nowrap" class="ft11">
                <b>{{ number_format($bill->amount, 2) }}</b>
            </p>
            <p style="position:absolute;top:345px;left:730px;white-space:nowrap" class="ft11">
                <b>{{ number_format($basicRate, 2) }}</b>
            </p>
            <p style="position:absolute;top:376px;left:730px;white-space:nowrap" class="ft11">
                <b>{{ number_format($totalAmount, 2) }}</b>
            </p>
            <p style="position:absolute;top:98px;left:373px;white-space:nowrap" class="ft12">
                <b>{{ $account_number }}</b>
            </p>
            <p style="position:absolute;top:134px;left:373px;white-space:nowrap" class="ft12">
                <b>{{ $name }}</b>
            </p>
            <p style="position:absolute;top:101px;left:717px;white-space:nowrap" class="ft12">
                <b>{{ $bill->bills_year }}</b>
            </p>
            <p style="position:absolute;top:255px;left:717px;white-space:nowrap" class="ft12">
                <b>{{ $phone }}</b>
            </p>
            <p style="position:absolute;top:423px;text-align:left;font-size:14px;line-height:1.0;margin:0;left:280px;width:calc(100% - 350px);"
                class="ft11">
                This bill must be paid in full before <b>1st April 2024</b> or within two weeks of the delivery date at
